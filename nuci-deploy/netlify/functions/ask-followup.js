...
5. Keep it to 2-4 short, practical sentences. Be specific to a ${species} where relevant. Plain text only, no markdown. Language: write in the SAME language the owner used in their answers (detect it from their free-text answers). If their language is unclear, use "${lang}".`;
